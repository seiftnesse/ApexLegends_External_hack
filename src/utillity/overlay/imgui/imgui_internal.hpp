...
static inline float  ImFabs(float x)                                            { return fabs(x); }
static inline float  ImSqrt(float x)                                            { return sqrt(x); }
static inline float  ImPow(float x, float y)                                    { return pow(x, y); }
static inline double ImPow(double x, double y)                                  { return ( double )ImPow( ( float )x, ( float )y ); }
static inline float  ImFmod( float x, float y ) { return fmodf( x, y ); }
static inline double ImFmod(double x, double y)                                 { return (double )ImFmod( (float )x, (float )y ); }
static inline float  ImCos(float x)                                             { return cos(x); }
static inline float  ImSin(float x)                                             { return sin(x); }
static inline float  ImAcos(float x)                                            { return ( float )acos( ( double )x ); }
static inline float  ImAtan2(float y, float x)                                  { return atan2(y, x); }
static inline double ImAtof(const char* s)                                      { return atof(s); }
static inline float  ImFloorStd(float x)                                        { return floorf( x ); }   // we already uses our own ImFloor() { return (float)(int)v } internally so the standard one wrapper is named differently (it's used by stb_truetype)
static inline float  ImCeil(float x)                                            { return ceil(x); }
#endif
